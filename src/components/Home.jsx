...
const Home = () => {
    return (
        <div className="font-[sans-serif] max-w-6xl max-md:max-w-md mx-auto my-20">
            <div className="grid md:grid-cols-2 items-center md:gap-10 gap-6">
                <div className="max-md:order-1 max-md:text-center">
                    ...
                    <p className="mt-5 text-base text-gray-500 leading-relaxed">
                        Effortlessly manage users with our comprehensive UMS, designed to streamline user roles, permissions, and activities. Elevate your organizational efficiency today
                    </p>
